...
{
    template <>
    struct hash<lstg::Subsystem::Render::GraphDef::ShaderTextureDefinition>
    {
        std::size_t operator()(const lstg::Subsystem::Render::GraphDef::ShaderTextureDefinition& value) const noexcept
        {
