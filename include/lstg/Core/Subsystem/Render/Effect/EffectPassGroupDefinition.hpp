...
namespace lstg::Subsystem::Render::Effect
{
    ...
    public:
         ...
         * @param pass Pass 对象
         */
        void AddPass(ImmutableEffectPassDefinitionPtr pass);
...
{
    template <>
    struct hash<lstg::Subsystem::Render::Effect::EffectPassGroupDefinition>
    {
        std::size_t operator()(const lstg::Subsystem::Render::Effect::EffectPassGroupDefinition& value) const
        {
