...
namespace lstg::Subsystem::Render::Effect
{
    ...
    public:
         ...
         */
        void AddSlot(uint32_t index, ElementSemantic semantic, bool normalized);
...
{
    template <>
    struct hash<lstg::Subsystem::Render::Effect::ShaderVertexLayoutDefinition>
    {
        std::size_t operator()(const lstg::Subsystem::Render::Effect::ShaderVertexLayoutDefinition& value) const
        {
